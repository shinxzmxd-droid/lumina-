...
import { adminCreateUser as _adminCreateUser, adminSetApproval as _adminSetApproval } from "@/server/admin-users.functions";
import { withAuthHeaders } from "@/lib/serverFnAuth";
const adminCreateUser = withAuthHeaders(_adminCreateUser);
const adminSetApproval = withAuthHeaders(_adminSetApproval);
